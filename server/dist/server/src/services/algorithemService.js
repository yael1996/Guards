...
var AlgorithemService = /** @class */ (function () {
    ...
    AlgorithemService.prototype.runAlgorithem = function (bordId, month) {
        return __awaiter(this, void 0, void 0, function () {
            var population, algo, best;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateFirstPopulation(bordId, month)];
                    case 1:
                        population = _a.sent();
                        algo = new geneticAlgorithem_1.GeneticAlgorithm(population);
                        return [4 /*yield*/, algo.run()];
                    case 2:
                        best = _a.sent();
